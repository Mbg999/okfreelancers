...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <meta charset="utf-8">
        <title>OkFreelancers | @lang('emails.passwordReset.passwordReset')</title>
    ...
    <body style="width: 100%">
        ...
        <div style="font-family: 'Open Sans', sans-serif;">
            ...
            <div style="background-color: #ececec; color: #1a1a1a; padding: 5px; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                <h3>@lang('emails.passwordReset.passwordReset')</h3>
                <p>@lang('emails.passwordReset.request')</p>
                <p>@lang('emails.passwordReset.notRequested')</p>
                <br>
                <p>@lang('emails.click')</p>
                <a href="{{ env('FRONT_WEB_URL') ."/passwordReset/$email/$token"}}">@lang('emails.passwordReset.passwordReset')</a>
                <p>@lang('emails.link'): <span>{{ env('FRONT_WEB_URL') ."/passwordReset/$email/$token"}}</span></p>
                <p>@lang('emails.passwordReset.expiration')</p>
            </div>
        </div>
    </body>
</html>
